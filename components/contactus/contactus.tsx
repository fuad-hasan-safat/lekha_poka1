...
export default function ContactUs() {
    ...
    return (
        <div className="flex flex-row space-x-5 place-content-center py-[110px]">
            <div className="flex flex-col w-[596px] space-y-5">
                <div>
                    <p className="text-[48px] text-[#F9A106]">যোগাযোগ করুন</p>
                </div>
